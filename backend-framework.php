...
<div class="container  p-5 text-center ">
    ...
    <div class="row">   
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/4836964_c172_2.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/3580711_74a7_2.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/2778478_7a46_7.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/2419768_7f90_2.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
...
<div class="container  p-5 text-center ">
    <div class="row">   
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/3176642_d2b2.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
          <h6 class="card-title">Laravel 7 Tutorial for Beginners</h6>
            <p class="card-text">Laravel Photo Gallery Project
</p>
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4409288_3149.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4323994_6528.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
...
<div class="container  p-5 text-center ">
    <div class="row">   
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/4539436_b342.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/2901978_2012_3.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/2551899_42b7_7.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/1304160_9449_3.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
...
<div class="container  p-5 text-center ">
    <div class="row">   
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/706204_a422_2.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/3539352_603a_2.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/3213693_2c3c_2.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/2695650_5ee6_8.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
