...
<h1>Cloud Computing<span class="color_h1"> Tutorial</span></h1>
<hr>
...
<div class="cloud-public mb-2">
  ...
  <span>
  Examples include Amazon EC2, Google App Engine, IBM SmartCloud Enterprise, Windows Azure Services Platform, and others.
  </span>
...
Because of this configuration, the hybrid cloud is only partially secure. The public cloud services are available to anyone, whereas the private cloud services are only available to the organization's users.
  </p>  
...
<div class="container mb-2">
  <div class="cloud-types">
    ...
    <p>Google Cloud Function, Microsoft Azure Functions, Webtask.io, Iron.io, Open Whisk, and AWS Lambda are all examples of FaaS.</span>
  </div>
</div>
...
<div class="container mb-2">
  <div class="cloud-types">
    ...
    <p>One of the most important benefits of cloud computing is cost savings. This allows you to save a significant amount as it does not require any physical hardware investment. 
      In addition, no trained personnel are required to maintain the hardware. The cloud service provider buys and manages the equipment.
      </p>   
  </div>
    <div class="container">
    <h3>High speed</h3>
    <p>Cloud computing enables us to quickly deploy the service with fewer clicks. This rapid deployment allows us to obtain the necessary resources for our systems in minutes.

      </p>   
  </div>
    <div class="container">
    <h3>Back-up and restore data</h3>
    <p>When data is stored in the cloud, it is easy to back up and restore it using the cloud.
      </p>   
  </div>
    <div class="container">
    <h3>No hardware required</h3>
    <p>
      There is no need for a physical storage facility as the cloud hosts everything.
       However, backups are recommended for disaster management and business continuity.
      
  </div>
    <div class="container">
    <h3>Reliability</h3>
    <p>
      The biggest advantage of cloud hosting is its reliability. Due to the instant updates, there is no need to be worried about the changes.
...
<div class="container">
  <div class="cloud-types">
    <h3>List of Top Cloud Service Providers</h3>
