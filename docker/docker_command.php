...
<div class='w3-card-2 topnav notranslate' id='topnav'>
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a href='/docker' class='topnav-icons fa fa-home w3-left w3-bar-item w3-button' title='Home'></a>
...
<h1>Docker<span class="color_h1" title="Docker Commands List"> Commands</span></h1>


<hr>

<div class="mb-4" title="Basic Docker Commands List">
  <h2 title="Basic Docker Commands List">Basic Docker Commands</h2>
  <ul>
    <li>docker ps</li>
    <li>docker ps -a</li>
    <li>docker run</li>
...
<p>In a Docker container that is running, execute a command.
  ...
  <figure class="highlight">
    <pre><code class="language-html" data-lang="html">
    sudo docker exec -i -t d13c942271d6 /bin/bash
  </code></pre></figure>
</div>
<div class="">
...
<div class="">
  ...
  <div class="container">
    <div class="digital-link">
      ...
      <div><a href="docker_installation" title="Docker Installation">Docker Installation</a></div>
      <div> <a href="docker_file" title="What is Docker File">What is Docker File</a></div>
      <div> <a href="docker_file" title="What is Docker File">What is Docker File</a></div>
    </div>
  </div>
