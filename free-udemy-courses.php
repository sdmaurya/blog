       ...
       <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
          <div class="single-course-category">
             <div class="course-content">
                <h6 class="course-category-title"> <a href="/docker">Web Development</a>  </h6>
             </div>
          </div>
       </div>
       <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
          <div class="single-course-category">
             <div class="course-content">
                <h6 class="course-category-title"> <a href="/docker">Databases</a>  </h6>
             </div>
          </div>
       </div>
       <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
          <div class="single-course-category">
             <div class="course-content">
                <h6 class="course-category-title"> <a href="/linux">Software Testing</a>  </h6>
             </div>
          </div>
       </div>
       <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
          <div class="single-course-category">
             <div class="course-content">
                <h6 class="course-category-title"> <a href="/git">Software Engineering</a>  </h6>
             </div>
          </div>
       </div>    
    </div>
