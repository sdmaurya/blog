...
<div class="container  pt-4 pb-4 text-center ">
    <div class="row">   
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/2075934_7459.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/3577203_a0ae_2.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4633954_2338.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4819656_efe7.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
...
<div class="container  pt-4 pb-4 text-center ">
    <div class="row">   
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/2803207_bd53_2.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4909416_b0c0.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4918814_f52b.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/5018432_4846_4.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
...
<div class="container  pt-4 pb-4 text-center ">
    <div class="row">   
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/5050440_bb5c.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4448262_ad80_4.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4860692_adee.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4737584_a2c8_2.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
...
<div class="container  pt-4 pb-4 text-center ">
    <div class="row">   
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/3285722_dbfc_5.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4539436_b342.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4323994_6528.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/4216812_697c.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
