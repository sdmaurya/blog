...
<h2>What is git</h2>
<p>Git is a distributed Version Control System that is used to track changes in source code during software development. <br> It is aimed at assisting programmers coordinate their efforts. Git stores progress of the project information in a repository. </p>
<p> Linus Torvalds created Git in 2005 for the development of the Linux kernel, with other kernel developers contributing to its early development. Junio Hamano has been its current maintainer since 2005. Git is free software licenced under the GNU General Public License version 2. </p>
<h2>What is Version Control</h2>
<p>Version Control System (VCS) is a piece of software that allows software developers to collaborate, maintain and keep a complete history of their work. </p>
<h2 title="What is a Git repository">What is a Git repository</h2>
