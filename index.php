    ...
    <div class="col-md-4">
      <div class="card" >
        ...
        <div class="card-body">
          ...
          <a href="/html" class="btn btn-warning">Read More</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      ...
      <img src="img/linux.png"  class="card-img-top" alt="...">
        ...
        <h4 class="card-title">LINUX</h4>
          ...
          <a href="/linux" class="btn btn-warning">Read More</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      ...
      <img src="img/d.jpg"  class="card-img-top" alt="...">
        ...
        <h4 class="card-title">DEVOPS</h4>
          ...
          <a href="/clouds/devops.php" class="btn btn-warning">Read More</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-4">
      ...
      <img src="img/aws.png"  class="card-img-top" alt="...">
        ...
        <h4 class="card-title">AWS</h4>
          ...
          <a href="/aws" class="btn btn-warning">Read More</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      ...
      <img src="img/block.png"  class="card-img-top" alt="...">
        ...
        <h4 class="card-title text-uppercase">Blockchain</h4>
          ...
          <a href="/blockchain" class="btn btn-warning">Read More</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      ...
      <img src="img/agile.jpg"  class="card-img-top" alt="...">
        ...
        <h4 class="card-title">AGILE</h4>
          ...
          <a href="/agile" class="btn btn-warning">Read More</a>
        </div>
      </div>
    </div>
  </div>
