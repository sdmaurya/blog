...
<h2>JSON Data Types Supported</h2>
<ul>
    <li>String</li>
    <li>Number</li>
    <li>Arrays</li>
 ...
 <div class="json-example">
  <h3 >JSON Methods In JavaScript</h3>
  
 
 <p> 1. JSON.parse() : This method takes a JSON string and turns it into a JavaScript object.</p>
 <p> 2. JSON.stringify() : Convert the JavaScript (JSON) object to a JSON string (useful when sending over a network).</p>
