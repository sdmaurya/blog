...
<h4 title="Linux/Unix Tutorial for Beginners">Linux/Unix Tutorial for Beginners</span></h4>
...
<h5>Some of the popular Linux distributions include :</h5>
<ul>
    <li>CentOS    
        </li>
        <li>Ubuntu</li>
...
<h4 title="Basic Linux Commands for Beginners">Basic Linux Commands for Beginners</span></h4>
<hr>
<div class="card card-body mb-3">
  <ul>
    <li><a href="linux_command.php/#pwd">pwd</a></li>
    <li>ls</li>
    <li>cd</li>
    <li> touch</li>
    <li>cat</li>
