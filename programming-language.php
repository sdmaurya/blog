...
<div class="container ctn-padding pt-4 pb-4 text-center ">
    ...
    <div class="row">      
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/642078_a41d_2.jpg"  class="card-img-top" alt="HTML5 and CSS3">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/468138_1b48_2.jpg"  class="card-img-top" alt="Javascript Essentials">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/9711_452b_8.jpg"  class="card-img-top" alt="C++ Tutorial for Complete Beginners">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/217000_3050_7.jpg"  class="card-img-top" alt="Introduction To Python Programming">
          <div class="card-body">
          <h6 class="card-title">Learn to Program in Javascript: Beginner to Pro</h6>
...
<div class="container ctn-padding pt-4 pb-4 text-center ">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/1325686_e03b_3.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/1273748_ef50_5.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/980984_bac8_2.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/706204_a422_2.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
...
<div class="container ctn-padding pt-4 pb-4 text-center "> 
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
          <img src="udemy/1675864_0386_3.jpg"  class="card-img-top" alt="A Beginners Guide to SQL">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/1582974_f2c5_4.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/81368_2296_5.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/1353848_735f_4.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
...
<div class="container ctn-padding pt-4 pb-4 text-center ">
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
          <div class="card" >
            <img src="udemy/2843938_74c9_2.jpg"  class="card-img-top" alt="A Beginners Guide to SQL">
            <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/17503_7fa8_9.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 mb-4 mb-md-0">
        <div class="card" >
        <img src="udemy/1832390_b41c.jpg"  class="card-img-top" alt="...">
          <div class="card-body">
